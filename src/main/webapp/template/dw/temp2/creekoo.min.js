//CreeKoo-JS KooPle Pro 20130627 www.creekoo.com
jQuery(document).ready(function(a){a(".fancybox").fancybox()}),jQuery(document).ready(function(a){a("#roll_top").click(function(){a("html,body").animate({scrollTop:"0px"},800)}),a("#ct").click(function(){a("html,body").animate({scrollTop:a("#comments").offset().top},800)}),a("#fall").click(function(){a("html,body").animate({scrollTop:a("#footer").offset().top},800)})}),jQuery(document).ready(function(){jQuery(".topnav ul li").hover(function(){jQuery(this).children("ul").show(),jQuery(this).addClass("li")},function(){jQuery(this).children("ul").hide(),jQuery(this).removeClass("li")})}),jQuery(document).ready(function(a){function h(c){var d=-c*b;a("#focus ul").stop(!0,!1).animate({left:d},300),a("#focus .btn span").stop(!0,!1).animate({opacity:"0.4"},300).eq(c).stop(!0,!1).animate({opacity:"1"},300)}var e,g,b=a("#focus").width(),c=a("#focus ul li").length,d=0,f="<div class='btn'>";for(g=0;c>g;g++)f+="<span></span>";f+="</div><div class='preNext pre'></div><div class='preNext next'></div>",a("#focus").append(f),a("#focus .btn span").css("opacity",.4).mouseenter(function(){d=a("#focus .btn span").index(this),h(d)}).eq(0).trigger("mouseenter"),a("#focus .preNext").css("opacity",0).hover(function(){a(this).stop(!0,!1).animate({opacity:"0.5"},300)},function(){a(this).stop(!0,!1).animate({opacity:"0"},300)}),a("#focus .pre").click(function(){d-=1,-1==d&&(d=c-1),h(d)}),a("#focus .next").click(function(){d+=1,d==c&&(d=0),h(d)}),a("#focus ul").css("width",b*c),a("#focus").hover(function(){clearInterval(e)},function(){e=setInterval(function(){h(d),d++,d==c&&(d=0)},4e3)}).trigger("mouseleave")}),jQuery(document).ready(function(){jQuery("#tabnav li").click(function(){jQuery(this).addClass("selected").siblings().removeClass(),jQuery("#tab-content > ul").eq(jQuery("#tabnav li").index(this)).fadeIn(800).siblings().hide()})}),jQuery(document).ready(function(){jQuery("a[rel='external'],a[rel='external nofollow']").click(function(){return window.open(this.href),!1})}),jQuery(document).ready(function(){jQuery(".icon1,.icon2,.icon3,.icon4").wrapInner('<span class="hover"></span>').css("textIndent","0").each(function(){jQuery("span.hover").css("opacity",0).hover(function(){jQuery(this).stop().fadeTo(350,1)},function(){jQuery(this).stop().fadeTo(350,0)})})}),jQuery(function(){jQuery("a img").not("#respond_box img,.r_wallreaders img,#focusbox img").lazyload({placeholder:"/wp-content/themes/KooPle/images/image-pending.gif",effect:"fadeIn"})}),jQuery(document).ready(function(a){function h(){return a.browser.msie&&"6.0"==a.browser.version?!0:!1}var b,c,d,e,f,g;h()||(b=0,c=a("#rollstart"),d=a("#sideroll"),c.before('<div class="rollbox"></div>'),e=c.offset(),f=a(window),g=c.prev(),f.width()>960&&f.scroll(function(){f.scrollTop()>e.top+b?(g.html(null)&&d.clone().prependTo(".rollbox"),a("#sideroll").size()>1&&a("#sideroll").eq(1).hide(),g.children().show(),g.show().stop().animate({paddingTop:0},400)):(g.hide().stop().animate({},400),a("#sideroll").size()>1&&a("#sideroll").eq(1).show())}))});
//lazyload
